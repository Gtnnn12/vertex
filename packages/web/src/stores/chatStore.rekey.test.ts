...
function msg(id: string): MessageWithUser {
  return {
    ...
    content: 'hi',
    createdAt: 1,
    user: { id: 'u', username: 'u', displayName: null, avatar: null, homeInstance: null, homeUserId: null, accentColor: null, banner: null, bio: null, status: 'online', customStatus: null, isAdmin: false, avatarColor: null, replicatedInstances: [], createdAt: 1 },
    replyToId: null,
    editedAt: null,
    attachments: [],
    embeds: [],
