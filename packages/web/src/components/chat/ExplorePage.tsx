    ...
    <div className="flex-1 flex flex-col bg-surface-chat h-full">
      ...
      <div className="h-12 px-4 flex items-center shadow-header flex-shrink-0 z-10 bg-surface-chat">
        <div className="flex items-center gap-2 mr-4">
          ...
          <span className="font-bold text-txt-primary">{t('explore')}</span>
        </div>
        ...
        {isLoading && spaces.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-64 opacity-80">
            ...
            <p className="text-txt-tertiary text-sm">
              {searchQuery
                ? t('no_spaces_match_search')
                : t('no_discoverable_spaces')}
            </p>
          </div>
        ) : (
    ...
    <div className={`bg-surface-channel rounded-lg border overflow-hidden flex flex-col transition-colors ${
      ...
      <div className="px-4 pt-2 pb-4 flex flex-col flex-1">
        ...
        {space.description ? (
          ...
          <p className="text-[13px] text-txt-tertiary italic mb-3 flex-1">{t('no_description')}</p>
        )}
        ...
        <div className="flex items-center gap-3 text-[12px] text-txt-tertiary mb-3">
          <span className="flex items-center gap-1">
            ...
            {space.memberCount} {space.memberCount === 1 ? t('member') : t('members')}
          </span>
          {originLabel && (
        ...
        {isJoined ? (
          ...
          <div className="space-y-2">
            <textarea
              ...
              placeholder={t('why_do_you_want_to_join')}
              rows={2}
            ...
            <div className="flex gap-2">
              ...
              >
                {joining ? t('sending') : t('send_request')}
              </button>
              <button
