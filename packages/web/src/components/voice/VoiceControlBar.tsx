    ...
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 opacity-0 translate-y-4 group-hover/voice:opacity-100 group-hover/voice:translate-y-0 transition-all duration-300 ease-out">
      <div className="flex items-center gap-1.5 rounded-full px-3 py-2 glass-bubble">
        ...
        <button
          ...
          title={(isSpaceMuted || isSpaceDeafened) ? (isMuted ? t('space_muted_self_muted') : t('space_muted')) : isMuted ? t('unmute_m') : t('mute_m')}
        >
        ...
        <button
          ...
          title={isSpaceDeafened ? t('space_deafened') : isDeafened ? t('undeafen_d') : t('deafen_d')}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button
          ...
          title={voiceFullscreen ? t('exit_fullscreen') : t('fullscreen')}
        >
          {voiceFullscreen ? (
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
