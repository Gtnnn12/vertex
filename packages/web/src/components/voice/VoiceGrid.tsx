        ...
        {otherTiles.length > 0 && (
          <div className="flex justify-center flex-shrink-0 py-1">
            <button
              ...
              title={stripHidden ? t('show_members') : t('hide_members')}
            >
              ...
              <span>{stripHidden ? t('show_members') : t('hide_members')}</span>
            </button>
          </div>
        )}
