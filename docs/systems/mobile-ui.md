...
- `DesktopPanel` exposes auto-launch, app-version + update check, and "Change Instance" — all of which call `window.VERTEX.*` IPC and are meaningless on web/iOS PWA.
