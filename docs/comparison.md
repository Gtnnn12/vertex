# VERTEX compared to other chat platforms

This page is an honest look at how VERTEX fits next to the tools people usually
...
Short version: VERTEX is for people who want a Discord-style experience they
...
| | VERTEX | Discord | Revolt | Spacebar | Matrix / Element | Mumble |
|---|---|---|---|---|---|---|
...
| Federation between servers | Yes, between VERTEX instances | No | No | No | Yes, open standard | No |
...
the moderation policy. VERTEX exists for the people who want the Discord shape
...
and federation. VERTEX is built around a full voice and video control surface
...
are central to you, VERTEX is aimed squarely at that. If you want a larger
...
voice stack is still maturing. VERTEX ships its own client and its own voice
and video stack, and it is federation-first rather than Discord-protocol-first.

## VERTEX vs Matrix and Element
...
stronger choice and VERTEX does not try to replace it. VERTEX federation is
newer, simpler, and currently peers VERTEX instances with each other rather
than speaking an open cross-ecosystem protocol. Where VERTEX differs is the
...
proven choice. VERTEX is a full communication platform (text, voice, video,
